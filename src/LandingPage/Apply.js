                ...
                <div className="col-md-4 col-sm-4">
                  <div className="applybox">
                    ...
                    <div className="applytext">
                      ...
                      <p>
                        As soon as we receive your results they will be emailed
                        to you instantly. Hard Copy certificates are also
                        available.
                      </p>
                    </div>
                  </div>
      ...
      <div className="fulldimanddiv">
        <div className="container">
          <div className="fulltxtdiv">
            <p>
              On Demand Checks allows you to apply online for a National Police
              Clearance Certificate for employment or volunteer purposes. If you
              require an Australian Federal Police (AFP) Police Check
              specifically for visa, citizenship or immigration purposes, you
              will need to apply online using our AFP Check website.
            </p>
          </div>
        </div>
      </div>
                    ...
                    <div className="accordion-group">
                      <div className="accordion-heading">
                        <a
                          ...
                          href="#collapse0"
                        >
                          <em className="icon-fixed-width fa fa-plus"></em>What
                          is a Nationally Coordinated Criminal History Check?
                        </a>
                      </div>
                      <div
                        style={{ height: "0px" }}
                        ...
                        <div className="accordion-inner">
                          ...
                          <ol>
                            ...
                            <li>
                              ...
                              proof of identity. - You will be asked to complete
                              information such as all names you have been known
                              by, 5 years of residential address history, date
                              of birth and contact details..&nbsp;Upload
                              ID.&nbsp;You will need access to a scanner or a
                              mobile device with a camera to upload your
                              Identification Documents.
                            </li>
                            <li>
                    ...
                    <div className="accordion-group">
                      <div className="accordion-heading">
                        <a
                          ...
                          href="#collapse2"
                        >
                          <em className="icon-fixed-width fa fa-plus"></em>Which
                          states do you provide Police Checks for?
                        </a>
                      </div>
                      <div
                        style={{ height: "0px" }}
                      ...
                      >
                        <div className="accordion-inner">
                          ...
                          <p>
                            ...
                            (PDF). You can purchase a hard copy certificate for
                            an additional $9.95. Hard copy certificates can only
                            be posted to an Australian postal address.
                          </p>
